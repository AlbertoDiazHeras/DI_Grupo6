  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="http://127.0.0.1:8000/usuarios" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><b>A</b>g</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Usuarios</b> Almagest</span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="{{ url('home') }}" class="btn btn-default btn-flat">Desconectar</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2021 <a href="#">Almagest</a>.</strong> All rights reserved.
      </footer>
